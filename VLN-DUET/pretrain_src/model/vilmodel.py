...
class ImageEmbeddings(nn.Module):
    ...
    def forward(
        ...
        split_traj_embeds = torch.split(traj_embeds, traj_step_lens, 0)         # step*batch, pano (why40?), dim
        split_traj_vp_lens = torch.split(traj_vp_lens, traj_step_lens, 0)       # tuple of batch size  (step, pano, dim)
